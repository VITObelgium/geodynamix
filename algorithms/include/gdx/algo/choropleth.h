...
void choropleth_sum(const RasterInputType& input, const AreaRasterType& areas, RasterOutputType& output)
{
    ...
    auto sums = sum_mask<TOutput>(input, areas);
...
template <
    ...
    typename RasterOutputType,
    typename AreaRasterType>
void choropleth_average(const RasterInputType& input, const AreaRasterType& areas, RasterOutputType& output)
{
