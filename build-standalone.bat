rm -rf standalone 
mkdir standalone
python build.py --dist --python-path=c:\python311\python.exe --build-dir=gdx-312
...
cp ./build/gdx-311-x64-windows-static-vs2022-dist/Release/geodynamix.cp312-win_amd64.pyd ./standalone
