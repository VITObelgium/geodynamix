...
class raster:
    ...
    def __add__(self, other: RasterLike) -> raster: ...
    def __sub__(self, other: RasterLike) -> raster: ...
    def __mul__(self, other: RasterLike) -> raster: ...
    def __truediv__(self, other: RasterLike) -> raster: ...
